...
# 31 "MCAL_Layer/GPIO/../std_libraries.h"
...
# 34 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t * config){
    ...
    if((((void*)0) == config) || (config->pin > 8 -1))
    {
        retVal = (Std_ReturnType)0x00;
    }else{
            switch(config->direction){
        case GPIO_DIRECTION_OUTPUT :
            (*tris_registers[config->port] &=~(((uint8)1<<config->pin)));
            break;
...
# 55 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t * config , direction_t * direcion_status){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if((((void*)0) == config) || (((void*)0) == direcion_status) || (config->pin > 8 -1))
    {
        retVal = (Std_ReturnType)0x00;
    }else{
       * direcion_status = ((*tris_registers[config->port] >> config->pin) & (uint8)1);
       retVal = (Std_ReturnType)0x01;
    }
    return retVal;
}
# 76 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t * config , logic_t logic_status){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if((((void*)0) == config) || (config->pin > 8 -1))
    {
        ...
        switch(logic_status){
            case GPIO_LOW:
                (*lat_registers[config->port] &=~(((uint8)1<<config->pin)));
                break;
            case GPIO_HIGH:
                (*lat_registers[config->port] |=((uint8)1<<config->pin));
                break;
            default : retVal = (Std_ReturnType)0x01;
        }
        retVal = (Std_ReturnType)0x01;
    }
    return retVal;
}
# 105 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_read_logic(const pin_config_t * config , logic_t *logic_status){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if((((void*)0) == config) || (((void*)0) == logic_status) || (config->pin > 8 -1))
    {
        retVal = (Std_ReturnType)0x00;
    }else{
        *logic_status = ((*port_registers[config->port] >> config->pin) & (uint8)1);
        retVal = (Std_ReturnType)0x01;
    }
    return retVal;
}
# 125 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t * config){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if((((void*)0) == config) || (config->pin > 8 -1))
    {
...
# 145 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_initialize(const pin_config_t * config){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if((((void*)0) == config) || (config->pin > 8 -1))
    {
...
# 235 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
...
# 255 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if(port > 5 - 1){
        retVal = (Std_ReturnType)0x00;
