...
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 31 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../compiler.h"
...
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../compiler.h" 2
# 14 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 34 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 16 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 50 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h" 1
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_gen_cfg.h" 1
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h" 2
# 57 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) void adc_input_channel_port_config(adc_channel_select_t channel);
# 25 "MCAL_Layer/ADC/hal_adc.c"
Std_ReturnType ADC_Init(const adc_config_t *adc){
...
# 61 "MCAL_Layer/ADC/hal_adc.c"
        ...
        else if(0x00U == adc->result_format){
            (ADCON2bits.ADFM = 0);
        }
        else{
            (ADCON2bits.ADFM = 1);
        ...
        if(0x01U == adc->voltage_reference){
            do{ADCON1bits.VCFG1 = 1; ADCON1bits.VCFG0 = 1; }while(0);
        }
        else if(0x00U == adc->voltage_reference){
...
# 188 "MCAL_Layer/ADC/hal_adc.c"
Std_ReturnType ADC_Get_Conversion_Result(const adc_config_t *adc , uint16 *conversion_result){
    Std_ReturnType retVal = (Std_ReturnType)0x00;
    if((((void*)0) == adc) || (((void*)0) == conversion_result)){
        retVal = (Std_ReturnType)0x00;
    }
    else{
        if(0x01U == adc->result_format){
