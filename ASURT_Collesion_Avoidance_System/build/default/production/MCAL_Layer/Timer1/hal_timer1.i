# 1 "MCAL_Layer/Timer1/hal_timer1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timer1/hal_timer1.c" 2
...
# 13 "MCAL_Layer/Timer1/../mcal_std_types.h"
# 1 "MCAL_Layer/Timer1/../std_libraries.h" 1
# 13 "MCAL_Layer/Timer1/../std_libraries.h"
...
# 13 "MCAL_Layer/Timer1/../std_libraries.h" 2
...
# 14 "MCAL_Layer/Timer1/../std_libraries.h" 2
...
# 15 "MCAL_Layer/Timer1/../std_libraries.h" 2
# 31 "MCAL_Layer/Timer1/../std_libraries.h"
...
# 13 "MCAL_Layer/Timer1/../compiler.h"
...
# 369 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC18Fxxxx_DFP/1.6.159/xc8\\pic\\include\\pic18_chip_select.h" 3
...
# 370 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC18Fxxxx_DFP/1.6.159/xc8\\pic\\include\\pic18_chip_select.h" 2 3
...
# 16 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h" 2
# 50 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 8 "MCAL_Layer/Timer1/hal_timer1.c" 2



static void (* TMR1_InterruptHandler)(void) = ((void*)0);


static uint16 Timer1_preload = ZERO_INIT;

static __attribute__((inline)) void timer1_mode_select(const timer1_t *timer);
...
# 51 "MCAL_Layer/Timer1/hal_timer1.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) void timer1_mode_select(const timer1_t *timer){
    if(timer->operation_mode == 0){
        (T1CONbits.TMR1CS = 0);
    }
    else if(timer->operation_mode == 1){
        (T1CONbits.TMR1CS = 1);
        if(timer->counter_mode == 1){
            (T1CONbits.T1SYNC = 1);
        }
        else if(timer->counter_mode == 0){
            (T1CONbits.T1SYNC = 0);
        }
    }
}
